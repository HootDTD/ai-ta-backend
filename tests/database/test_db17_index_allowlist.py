...
EXPECTED_INDEXES: set[tuple[str, str, str, bool, bool, tuple[str, ...], str | None]] = {
    ("app.ai_usage_reports", "ai_usage_reports__chat_id__idx", "btree", False, False, ("chat_id",), None),
    ("app.ai_usage_reports", "ai_usage_reports__user_course__idx", "btree", False, False, ("user_id", "course_id"), None),
    ("app.ai_usage_reports", "ai_usage_reports_pkey", "btree", True, True, ("id",), None),
    ("app.chat_messages", "chat_messages__course_activity__idx", "btree", False, False, ("course_id", "learning_activity_id"), None),
    ("app.chat_messages", "chat_messages_learning_activity_id_external_id_key", "btree", True, False, ("learning_activity_id", "external_id"), None),
    ("app.chat_messages", "chat_messages_learning_activity_id_turn_index_key", "btree", True, False, ("learning_activity_id", "turn_index"), None),
    ("app.chat_messages", "chat_messages_pkey", "btree", True, True, ("id",), None),
    ("app.concepts", "concepts__course_subject__idx", "btree", False, False, ("course_id", "subject_slug"), None),
    ("app.concepts", "concepts_course_id_subject_slug_slug_key", "btree", True, False, ("course_id", "subject_slug", "slug"), None),
    ("app.concepts", "concepts_pkey", "btree", True, True, ("id",), None),
    ("app.course_invites", "course_invites__active_code__uidx", "btree", True, False, ("code",), "is_active"),
    ("app.course_invites", "course_invites__created_by_course__idx", "btree", False, False, ("created_by", "course_id"), None),
    ("app.course_invites", "course_invites_pkey", "btree", True, True, ("id",), None),
    ("app.course_memberships", "course_memberships__course_role_user__idx", "btree", False, False, ("course_id", "role", "user_id"), None),
    ("app.course_memberships", "course_memberships_pkey", "btree", True, True, ("user_id", "course_id"), None),
    ("app.courses", "courses_pkey", "btree", True, True, ("id",), None),
    ("app.courses", "courses_slug_key", "btree", True, False, ("slug",), None),
    ("app.documents", "documents__course_created__idx", "btree", False, False, ("course_id", "created_at"), None),
    ...
    ("app.documents", "documents_unique_identifier_hash_key", "btree", True, False, ("unique_identifier_hash",), None),
    ("app.learner_entities", "learner_entities__course_concept__idx", "btree", False, False, ("course_id", "concept_id"), None),
    ("app.learner_entities", "learner_entities_concept_id_canonical_key_key", "btree", True, False, ("concept_id", "canonical_key"), None),
    ("app.learner_entities", "learner_entities_pkey", "btree", True, True, ("id",), None),
    ("app.learner_state", "learner_state__entity_id__idx", "btree", False, False, ("entity_id",), None),
    ("app.learner_state", "learner_state_pkey", "btree", True, True, ("user_id", "course_id", "entity_id"), None),
    ("app.learning_activities", "learning_activities__active_tutoring_user_course__uidx", "btree", True, False, ("user_id", "course_id"), "((status = 'active'::text) AND (modality = 'tutoring'::text))"),
    ("app.learning_activities", "learning_activities__current_problem_id__idx", "btree", False, False, ("current_problem_id",), None),
    ("app.learning_activities", "learning_activities__user_course__idx", "btree", False, False, ("user_id", "course_id"), None),
    ("app.learning_activities", "learning_activities_external_id_key", "btree", True, False, ("external_id",), None),
    ("app.learning_activities", "learning_activities_pkey", "btree", True, True, ("id",), None),
    ("app.mastery_events", "mastery_events__attempt_entity_kind__uniq", "btree", True, False, ("attempt_id", "entity_id", "event_kind"), None),
    ("app.mastery_events", "mastery_events__attempt_id__idx", "btree", False, False, ("attempt_id",), None),
    ("app.mastery_events", "mastery_events__concept_problem_id__idx", "btree", False, False, ("concept_problem_id",), None),
    ("app.mastery_events", "mastery_events__course_entity__idx", "btree", False, False, ("course_id", "entity_id"), None),
    ("app.mastery_events", "mastery_events__user_entity_created__idx", "btree", False, False, ("user_id", "entity_id", "created_at"), None),
    ("app.mastery_events", "mastery_events_pkey", "btree", True, True, ("id",), None),
    ("app.problem_attempts", "problem_attempts__activity_created__idx", "btree", False, False, ("learning_activity_id", "created_at"), None),
    ("app.problem_attempts", "problem_attempts__learner_retry__idx", "btree", False, False, ("learner_update_next_attempt_at",), "learner_update_pending"),
    ("app.problem_attempts", "problem_attempts__problem_id__idx", "btree", False, False, ("problem_id",), None),
    ("app.problem_attempts", "problem_attempts__user_course__idx", "btree", False, False, ("user_id", "course_id"), None),
    ("app.problem_attempts", "problem_attempts_pkey", "btree", True, True, ("id",), None),
    ("app.problems", "problems__concept_tier_difficulty__idx", "btree", False, False, ("concept_id", "tier", "difficulty"), None),
    ("app.problems", "problems__course_quarantined__idx", "btree", False, False, ("course_id", "quarantined_at"), None),
    ("app.problems", "problems_concept_id_problem_code_key", "btree", True, False, ("concept_id", "problem_code"), None),
    ("app.problems", "problems_pkey", "btree", True, True, ("id",), None),
    ("app.provisioning_runs", "provisioning_runs__authored_course_set__uidx", "btree", True, False, ("course_id", "set_index"), "(kind = 'authored_set'::text)"),
    ("app.provisioning_runs", "provisioning_runs__course_concept__idx", "btree", False, False, ("course_id", "concept_id"), None),
    ("app.provisioning_runs", "provisioning_runs__ingest_run_id__idx", "btree", False, False, ("ingest_run_id",), None),
    ("app.provisioning_runs", "provisioning_runs__problem_document__idx", "btree", False, False, ("problem_document_id",), None),
    ("app.provisioning_runs", "provisioning_runs__solution_document__idx", "btree", False, False, ("solution_document_id",), None),
    ("app.provisioning_runs", "provisioning_runs_pkey", "btree", True, True, ("id",), None),
    ("app.question_opportunities", "question_opportunities__activity_id__idx", "btree", False, False, ("learning_activity_id",), None),
    ("app.question_opportunities", "question_opportunities__course_session__idx", "btree", False, False, ("course_id", "learning_activity_id"), None),
    ("app.question_opportunities", "question_opportunities_attempt_id_reference_node_id_key", "btree", True, False, ("attempt_id", "reference_node_id"), None),
    ("app.question_opportunities", "question_opportunities_pkey", "btree", True, True, ("id",), None),
    ("app.student_progress", "student_progress_pkey", "btree", True, True, ("user_id", "course_id"), None),
    ("app.tutoring_messages", "tutoring_messages__attempt_id__idx", "btree", False, False, ("attempt_id",), None),
    ("app.tutoring_messages", "tutoring_messages__course_activity__idx", "btree", False, False, ("course_id", "learning_activity_id"), None),
    ("app.tutoring_messages", "tutoring_messages_learning_activity_id_turn_index_key", "btree", True, False, ("learning_activity_id", "turn_index"), None),
    ...
    ("app.uploads", "uploads__latest_course_week_kind__uidx", "btree", True, False, ("course_id", "week", "kind"), "is_latest"),
    ("app.uploads", "uploads__uploaded_by_course__idx", "btree", False, False, ("uploaded_by", "course_id"), None),
    ("app.uploads", "uploads_pkey", "btree", True, True, ("id",), None),
    ("internal.chat_routing_decisions", "chat_routing_decisions__course_session__idx", "btree", False, False, ("course_id", "learning_activity_id"), None),
    ("internal.chat_routing_decisions", "chat_routing_decisions_pkey", "btree", True, True, ("id",), None),
    ("internal.chat_session_snippets", "chat_session_snippets__chunk_id__idx", "btree", False, False, ("chunk_id",), None),
    ("internal.chat_session_snippets", "chat_session_snippets__course_session__idx", "btree", False, False, ("course_id", "learning_activity_id"), None),
    ("internal.chat_session_snippets", "chat_session_snippets_pkey", "btree", True, True, ("learning_activity_id", "chunk_id"), None),
    ("internal.content_ingest_errors", "content_ingest_errors__course_run__idx", "btree", False, False, ("course_id", "ingest_run_id"), None),
    ("internal.content_ingest_errors", "content_ingest_errors_pkey", "btree", True, True, ("id",), None),
    ("internal.content_ingest_runs", "content_ingest_runs__course_document__idx", "btree", False, False, ("course_id", "document_id"), None),
    ("internal.content_ingest_runs", "content_ingest_runs_pkey", "btree", True, True, ("id",), None),
    ("internal.dedup_decisions", "dedup_decisions__concept_id__idx", "btree", False, False, ("concept_id",), None),
    ("internal.dedup_decisions", "dedup_decisions__course_run__idx", "btree", False, False, ("course_id", "ingest_run_id"), None),
    ("internal.dedup_decisions", "dedup_decisions__matched_entity_id__idx", "btree", False, False, ("matched_entity_id",), None),
    ("internal.dedup_decisions", "dedup_decisions_pkey", "btree", True, True, ("id",), None),
    ("internal.document_chunks", "document_chunks__content_fts__idx", "gin", False, False, ("to_tsvector('english'::regconfig, content)",), None),
    ("internal.document_chunks", "document_chunks__course_document__idx", "btree", False, False, ("course_id", "document_id"), None),
    ("internal.document_chunks", "document_chunks__document_page__idx", "btree", False, False, ("document_id", "page_number"), None),
    ("internal.document_chunks", "document_chunks__embedding_halfvec_hnsw__idx", "hnsw", False, False, ("(embedding::extensions.halfvec(3072))",), None),
    ("internal.document_chunks", "document_chunks_pkey", "btree", True, True, ("id",), None),
    ("internal.entity_prerequisites", "entity_prerequisites__course_from__idx", "btree", False, False, ("course_id", "from_entity_id"), None),
    ("internal.entity_prerequisites", "entity_prerequisites__to_entity_id__idx", "btree", False, False, ("to_entity_id",), None),
    ("internal.entity_prerequisites", "entity_prerequisites_pkey", "btree", True, True, ("from_entity_id", "to_entity_id"), None),
    ("internal.grading_runs", "grading_runs__attempt_created__idx", "btree", False, False, ("attempt_id", "created_at"), None),
    ("internal.grading_runs", "grading_runs__concept_id__idx", "btree", False, False, ("concept_id",), None),
    ("internal.grading_runs", "grading_runs__course_user__idx", "btree", False, False, ("course_id", "user_id"), None),
    ("internal.grading_runs", "grading_runs__problem_id__idx", "btree", False, False, ("problem_id",), None),
    ("internal.grading_runs", "grading_runs__user_course__idx", "btree", False, False, ("user_id", "course_id"), None),
    ("internal.grading_runs", "grading_runs_attempt_id_role_grader_version_key", "btree", True, False, ("attempt_id", "role", "grader_version"), None),
    ("internal.grading_runs", "grading_runs_pkey", "btree", True, True, ("id",), None),
    ("internal.ingest_page_evidence", "ingest_page_evidence__course_run__idx", "btree", False, False, ("course_id", "ingest_run_id"), None),
    ("internal.ingest_page_evidence", "ingest_page_evidence__document_id__idx", "btree", False, False, ("document_id",), None),
    ("internal.ingest_page_evidence", "ingest_page_evidence_pkey", "btree", True, True, ("id",), None),
    ("internal.upload_jobs", "upload_jobs__course_upload__idx", "btree", False, False, ("course_id", "upload_id"), None),
    ("internal.upload_jobs", "upload_jobs__dequeue__idx", "btree", False, False, ("state", "lease_expires_at", "created_at"), None),
...
async def test_no_duplicate_indexes_on_any_table(schema_conn):
    ...
    assert not duplicates, f"duplicate indexes found (table/am/keys/predicate -> names): {duplicates}"
...
async def test_fk_coverage_matches_pinned_known_gap_set(schema_conn):
    ...
    for row in fk_rows:
        ...
        covered = any(
            keys[: len(fk_cols)] == fk_cols for keys in table_keys.get(table, [])
        )
        if not covered:
